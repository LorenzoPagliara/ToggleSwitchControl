...
class ToggleSwitchSimplifiedModel(ToggleSwitchModel):
    ...
    def __init__(self, stochasticity, LacI_ref, TetR_ref, t_step, total_time, avg_period) -> None:
        super().__init__(stochasticity, LacI_ref, TetR_ref, t_step, total_time, avg_period)

    def set_model(stochasticity=False, LacI_ref=750, TetR_ref=300):
